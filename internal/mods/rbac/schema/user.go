...
type User struct {
	...
	UserGender int       `json:"user_gender"`                   // UserGender of user (1-male, 2-female)
...
type UserQueryParam struct {
	...
	UserGender   int    `form:"user_gender"` // Gender of user (1-male, 2-female)
...
type UserForm struct {
	...
	UserGender int       `json:"user_gender" binding:"required,oneof=1 2,max=2"` // Email of user
	Email      string    `json:"email" binding:"max=128"`                        // Email of user
	Remark     string    `json:"remark" binding:"max=1024"`                      // Remark of user
	Status     int       `json:"status" binding:"required,oneof=1 2,max=2"`      // Status of user (1-activated, 0-freezed)
